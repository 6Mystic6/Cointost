			...
			<div className="row">
				<div className="col-md-12">
					<div className="text-center text-muted">
						<center><h1 style={{color:'yellow'}}>{clicks} tc</h1></center>
					</div>
                <div className="text-center text-muted">
				<center><p style={{color:'white'}}>Алко-майнинг: + {aspeed}</p></center>
                <center><p style={{color:'white'}}>Алко-кликер: + {speed}</p></center>
				</div>
                <div className="text-center buttons">
						<div className="d-flex justify-content-around">
							...
							<div className="justify-content-around">
								...
								<p className="text-buttons text-muted text-monospace">Гоп стоп</p>
							</div>
                            <div className="justify-content-around">
								<button className="btn btn-shop" onClick={go} data-to="persik">
									<Icon24Gift className="buttons_custom" />
								</button>
								<p className="text-buttons text-muted text-monospace">Бар</p>
							</div>
						</div>
					</div>
				</div>
